...
config :burox,
  ...
  buro_user_sae: [{:system, "BURO_USER_SAE"}, :instance_role],
  buro_password_sae: [{:system, "BURO_PASSWORD_SAE"}, :instance_role],
  buro_user_special: [{:system, "BURO_USER_SPECIAL"}, :instance_role],
  buro_password_special: [{:system, "BURO_PASSWORD_SPECIAL"}, :instance_role],
  buro_user_special_sae: [{:system, "BURO_USER_SPECIAL_SAE"}, :instance_role],
  buro_password_special_sae: [{:system, "BURO_PASSWORD_SPECIAL_SAE"}, :instance_role],
