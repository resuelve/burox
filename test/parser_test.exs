    ...
    assert response ==
             %Burox.Response{
               ...
               creditos: [
                 ...
                 %{
                   MOP_de_la_morosidad_mas_alta: nil,
                   clasificacion_de_puntualidad_de_pago: "UR",
                   ...
                   fecha_de_la_morosidad_historica_mas_alta: nil,
                   fecha_de_reporte_de_informacion: ~D[2016-04-30],
                   fecha_de_ultima_compra: nil,
                   fecha_de_ultimo_pago: nil,
                   ...
                   moneda_del_credito: "MX",
                   monto_a_pagar: nil,
                   monto_del_ultimo_pago: nil,
                   nombre_del_usuario: "TIENDA COMERCIAL",
                   numero_telefonico_del_usuario: "0",
                   saldo_actual: 0.0,
                   saldo_de_la_morosidad_historica_mas_alta: nil,
                   saldo_vencido: 0.0,
                   tipo_de_cuenta: "R",
                   tipo_de_producto: "CC",
                   tipo_de_responsabilidad_de_la_cuenta: "I"
                 ...
                 %{
                   ...
                   fecha_mas_antigua_del_historico_de_pagos: nil,
                   fecha_mas_reciente_del_historico_de_pagos: nil,
                   frecuencia_de_pagos: "Z",
                   historico_de_pagos: nil,
               ...
               direcciones_de_trabajo: [
                 ...
                 %{
                   fecha_de_contratacion: nil,
                   fecha_de_reporte_de_empleo: nil,
                   ocupacion: nil,
                   origen_de_la_razon_social: "MX",
                   primera_linea_de_direccion: "",
